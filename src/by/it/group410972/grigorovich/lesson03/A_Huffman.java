...
public class A_Huffman {
    ...
    String encode(InputStream inputStream) throws FileNotFoundException {
        ...
        // 2. Помещаем листья в очередь с приоритетом по частоте
    ...
    // Абстрактный базовый класс узла
    abstract class Node implements Comparable<Node> {
        ...
        public int compareTo(Node other) {
            return Integer.compare(this.frequence, other.frequence);
        }
    }
